...
public class InsertDataToAllTablesTest {
	...
	public void setup() {
		...
		inisTest = new InisTest(suite, "InisTest from Test", browser, "This is generated from a test. Should be deleted");
	...
	public void testAllProjectDataDelete() {
		...
		Assert.assertTrue(ddbc.deleteAllProjectData(project));
	}
}
